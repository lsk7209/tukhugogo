...
export const guideTopics: GuideTopic[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "business-fit",
        heading: "출원 전 사업 적합성 점검",
        body: [
          "출원 절차를 시작하기 전에는 이 발명이 어떤 사업 자산을 보호하는지 먼저 정리해야 합니다. 제품 자체를 보호하려는지, 제조 공정을 막으려는지, 소재 조성 범위를 확보하려는지에 따라 선행기술 조사와 청구항 설계가 달라집니다. 보호하려는 대상이 불명확하면 명세서는 길어져도 실제 권리 범위가 약해질 수 있습니다.",
          "특허 출원 방법을 검토할 때는 공개 시점도 함께 봐야 합니다. 이미 전시회, 논문, 제안서, 상세페이지에서 핵심 내용이 공개됐다면 신규성 판단에 영향을 줄 수 있으므로 공개 날짜와 공개 범위를 먼저 정리해야 합니다. 반대로 아직 실험 데이터가 부족하다면 출원 전에 최소 구현예와 비교 효과를 보강하는 편이 중간사건 대응에 유리합니다."
        ]
      },
      {
        id: "registration",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "ipc-search-steps",
        heading: "IPC 분류 뜻을 검색식에 반영하는 순서",
        body: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "decision-use",
        heading: "특허 동향 분석 결과를 의사결정에 쓰는 법",
        body: [
      ...
      {
        id: "review-log",
        heading: "특허맵 검토 기록 남기기",
        body: "마지막에는 검색일, 사용한 검색식, 제외한 키워드, 대표 문헌 번호, 판단을 보류한 항목을 기록합니다. 검토 기록이 있어야 나중에 데이터가 갱신됐을 때 같은 기준으로 다시 비교할 수 있고, 보고서 결론의 근거도 명확해집니다."
      },
      {
        id: "next-step",
        heading: "다음 분석 단계",
